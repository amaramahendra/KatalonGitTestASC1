...
WebUI.click(findTestObject('Button/Page_American Software Contracts  Marketplace for Oracle Fusion Oracle E-business suite Oracle Peoplesoft Consultants  Buyers Vendors and Users/button_login'))
...
not_run: WebUI.click(findTestObject('Fixed project/Page_Dashboard  American Software Contracts/span_Fixed project'))

not_run: WebUI.click(findTestObject('Object Repository/Page_Dashboard  American Software Contracts/li_Fixed project'))
